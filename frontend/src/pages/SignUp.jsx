    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center p-4" style={{ backgroundColor: bgColor }}>
            <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border-[1px]`} style={{ borderColor: borderColor }}>
                ...
                <p className="text-gray-600 mb-8">Create your account to get started with delicious food and seamless ordering experience.</p>
                ...
                <div className="mb-4">
                    ...
                    <div className="relative">
                        <input
                            ...
                            value={password}
                        />
                        <button className="absolute right-3 top-[13px] cursor-pointer text-gray-500" onClick={() => setShowPassword((prev) => !prev)}>
                ...
                <button
                    className="w-full mt-4 flex items-center justify-center gap-2 rounded-lg px-4 py-3 font-medium text-gray-600 shadow-sm transition duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2"
                    style={{
                        backgroundColor: "white",
                ...
                <p className="text-gray-600  text-center cursor-pointer mt-2" onClick={() => navigate("/signin")}>
                    ...
                    <a href="/signin" className="font-semibold" style={{ color: primaryColor }}>
                        Sign In
                    </a>
                </p>
            </div>
